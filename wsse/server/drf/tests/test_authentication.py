...
class WSSEAuthenticationTests(APITestCase):
    ...
    def http_auth(self, header):
        ...
        The headers are automatically cleared afterward.
        """
    ...
    def setUpClass(cls):
        ...
        cls.user = user_model.objects.create(username='test')
    ...
    def make_header_values(self, user=None, username=None, timestamp=None,
        ...
        :type user: result of get_user_model()
    ...
    def test_valid_authentication_drift(self):
        ...
        _timestamp = ts.strftime('%Y-%m-%dT%H:%M:%S.%fZ')
